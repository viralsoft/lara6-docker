...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ __('virals-inventory::labels.export.list') }}</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row form-group">
                    <div class="col-sm-12 pull-right">
                        <a href="{{ route('admin.exports.create') }}" class="btn btn-success"><i class="fa fa-edit"></i>
                            {{ __('virals-inventory::labels.export.create') }}</a>
                    </div>
                </div>
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ __('virals-inventory::labels.export.list') }}</h3>
                    </div>
                </div>
                        ...
                        @if($exports->count() > 0)
                            @foreach($exports as $key => $export)
                                <tr>
                                    ...
                                    <td>{{ @$export->date }}</td>
                                    <td>
                                        <a href="{{ route('admin.exports.show', $export->id) }}"
                                           class="btn btn-xs btn-info"><i
                                                    class="fa fa-search"></i></a>
{{--                                        <a href="{{ route('admin.exports.edit', $export->id) }}"--}}
{{--                                           class="btn btn-xs btn-primary"><i--}}
{{--                                                    class="fa fa-pencil"></i></a>--}}
{{--                                        <a class="btn btn-xs btn-danger delete_export"--}}
{{--                                           data-url=""><i class="fa fa-trash"></i></a>--}}
                    ...
                    <div class="row mbm">
                        <div class="col-sm-6">
                            <span class="record-total">{{ __('virals-inventory::messages.show') }} {{ $exports->count() }} / {{ $exports->total() }} {{ __('virals-inventory::messages.result') }}</span>
                        </div>
                        <div class="col-sm-6">
...
@section('scripts')
    <script>
        var request = false;
        $(document).on('click', 'a.delete_export', function (e) {
